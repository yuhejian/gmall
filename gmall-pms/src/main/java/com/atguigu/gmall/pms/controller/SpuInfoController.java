...
public class SpuInfoController {
    ...
    @GetMapping
    public Resp<PageVo> getSpuInfo(QueryCondition queryCondition, @RequestParam(value = "catId",defaultValue = "0") Long catId) {
        PageVo pageVo = spuInfoService.getSpuInfo(queryCondition, catId);
